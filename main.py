...
pekerjaan1 = [
    ...
    DeskripsiPekerjaan(
        ...
        keterampilan_dibutuhkan=["desain grafis", "media sosial", "microsoft office"],
        gaji=5000000,
...
sorted_pekerjaan = merge_sort_pekerjaan(
    pekerjaan_list=pekerjaan1, profil=profil1, preferensi="skor_gaji"
)
